        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `hhttps://github.com/evonianetwork/EvoniaMc_Launcher/releases/download/v${info.version}/Utopicube-Launcher-setup-${info.version}.dmg`
                    showUpdateUI(info)
                }
            ...
            case 'update-downloaded':
                loggerAutoUpdaterSuccess.log('Mise a jour ' + info.version + ' prêt pour l\'installation.')
            ...
            case 'update-not-available':
                loggerAutoUpdater.log('Aucune mise a jour trouvée.')
                settingsUpdateButtonStatus('Recherche de mise a jours')
                break
            case 'ready':
